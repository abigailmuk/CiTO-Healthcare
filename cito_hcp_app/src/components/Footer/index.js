...
import logo from '../../images/cito-health-logo.png'
const Footer = () => {
    const toggleHome = () => {
        scroll.scrollToTop()
    }
  return (
    <FooterContainer>
        <FooterWrap> 
            ...
            <SocialMedia> 
                <SocialMediaWrap>
                    <SocialLogo to="/" onClick={ toggleHome } >CITO</SocialLogo>
                    ...
                    <SocialIcons>
                        ...
                        <SocialIconLink href="https://twitter.com/explore" target="_blank" aria-label="Twitter">
                            <FaTwitter />
                        </SocialIconLink>
                    </SocialIcons>
                </SocialMediaWrap>
